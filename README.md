...
> Άνοιγμα αυτής της σελίδας στο [https://tsiozos.github.io/print-sensors/](https://tsiozos.github.io/print-sensors/)
...
* αναζήτηση για **https://github.com/tsiozos/print-sensors** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/tsiozos/print-sensors/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/tsiozos/print-sensors** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/tsiozos/print-sensors/raw/master/.github/makecode/blocks.png)
